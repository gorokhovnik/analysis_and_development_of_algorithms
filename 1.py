...
theoretical_time5 = [experimental_time5[-1] / (N ** 2) * n * n for n in range(N + 1)]
...
theoretical_time6 = [experimental_time6[-1] / N / np.log(N) * n * np.log(n) for n in range(N + 1)]
...
theoretical_time8 = [experimental_time8[-1] / (N ** 3) * (n ** 3) for n in range(N + 1)]
